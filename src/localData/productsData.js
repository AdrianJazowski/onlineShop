/** @format */
import Iphone11 from "../assets/images/Iphone-11-64-gb.jpg";
import SamsungGalaxyS20 from "../assets/images/Smartfon Samsung Galaxy S20.jpg";
import SamsungGalaxyA20 from "../assets/images/Smartfon Samsung Galaxy A20e.jpg";
import SmartfonHuaweiP40Lite from "../assets/images/Smartfon Huawei P40 Lite.jpg";
import SmartfonXiaomiMiNote10Lite from "../assets/images/Smartfon Xiaomi Mi Note 10 Lite.jpg";
import SmartfonSamsungGalaxyA40from from "../assets/images/Smartfon Samsung Galaxy A40.jpg";
import SmartfonSamsungGalaxyA51 from "../assets/images/Smartfon Samsung Galaxy A51.jpg";
import SmartfonAppleiPhone7Plus32GB from "../assets/images/Smartfon Apple iPhone 7 Plus 32 GB.jpg";
import SmartfonAppleiPhone1164GB from "../assets/images/Smartfon Apple iPhone 11 64 GB.jpg";
import SmartfonRealme6128GB from "../assets/images/Smartfon Realme 6 128GB.jpg";

export const productsData = [
  {
    id: 1,
    productName: "Smartfon Apple iPhone 11 Czarny ",
    productPrice: 2999,
    productQuantity: 1,
    productCategory: "Apple",
    productDescription:
      "Ekrany smartfonów o przekątnej długości 6.1 cali wpiszą się w zakres preferencji najbardziej wymagających użytkowników. Tak duży wyświetlacz pozwoli na wysoki komfort oglądania treści multimedialnych. Jeżeli rozdzielczość będzie na odpowiednio wysokim poziomie, filmy i zdjęcia przedstawią wiele nawet najdrobniejszych detali. Większe smartfony to również idealne rozwiązanie dla osób, które często pracują przy dokumentach tekstowych oraz oczekują wygody korzystania z przeglądarki internetowej.",
    productImage: Iphone11,
    freeDelivery: true,
  },
  {
    id: 2,
    productName: "Smartfon Samsung Galaxy S20",
    productPrice: 3499,
    productQuantity: 1,
    productCategory: "Samsung",
    productDescription:
      "Korzystaj z mocy trzech obiektywów i rozdzielczości 64MP, by utrwalać chwile i wykonywać fotografie o zachwycających parametrach. W skupieniu się na detalach i odległych obiektach pomocny będzie trzykrotny hybrydowy zoom optyczny oraz Super Resolution Zoom. Fotografowanie w trudnych warunkach oświetleniowych także będzie o wiele łatwiejsze, a wszystko to za sprawą trzykrotnie większego i dokładniejszego czujnika obrazu, który we współpracy z zaawansowanymi rozwiązaniami AI umożliwia wykonanie wyraźnych i efektownych fotografii nocnych.",
    productImage: SamsungGalaxyS20,
    freeDelivery: true,
  },
  {
    id: 3,
    productName: "Smartfon Samsung Galaxy A20e",
    productPrice: 759,
    productQuantity: 1,
    productCategory: "Samsung",
    productDescription:
      "Smartfon z podwójnym aparatem sprawdzi się w rękach użytkowników, którzy oczekują nieco szerszych możliwości fotograficznych. Drugi aparat będzie wspierał główny obiektyw i oferował dodatkowe funkcje zaimplementowane przez producenta. Może np. odpowiadać za jakość prezentacji obiektów, znajdujących się w ruchu lub stanowić obiektyw szerokokątny. Możliwości jest wiele, a każdy entuzjasta zdjęć będzie mógł dostosować wybór do osobistych upodobań. Przy zakupie warto zwrócić uwagę na pozostałe parametry fotograficzne.",
    productImage: SamsungGalaxyA20,
    freeDelivery: false,
  },
  {
    id: 4,
